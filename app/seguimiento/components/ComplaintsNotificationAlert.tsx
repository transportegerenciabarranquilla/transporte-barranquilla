...
export function ComplaintsNotificationAlert({ complaints, onClose }: { complaints: ComplaintRecord[]; onClose: () => void }) {
    ...
    <section className="relative mb-6 rounded-lg border border-red-200 bg-red-50 p-5 shadow-sm sm:p-6">
      ...
      <div className="flex items-start gap-3 pr-10">
        ...
        <div>
          ...
          <h2 className="mt-1 text-xl font-black text-[#10223d]">Logisticos tiene {complaints.length} {complaints.length === 1 ? "queja acumulada" : "quejas acumuladas"}</h2>
