...
export function SeguimientoHero({ resumen }: { resumen: ResumenSeguimiento }) {
  return (
      ...
      <div className="relative p-6 sm:p-8">
        ...
        <div className="relative flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <h1 className="text-3xl font-semibold leading-tight sm:text-4xl">Seguimiento logistico</h1>
            <p className="mt-3 max-w-2xl text-sm leading-6 text-white/70">
              Monitorea vehiculos, avance de visitas, carga movilizada y novedades de ruta en tiempo real simulado.
            </p>
          </div>
          ...
          <div className="min-w-[220px] rounded-md border border-white/15 bg-white/10 p-4">
            ...
            <div className="mt-3 flex items-end gap-3">
              <span className="text-4xl font-semibold text-[#f5bd19]">{resumen.avance}%</span>
              <span className="pb-1 text-sm text-white/70">
                {resumen.visitados}/{resumen.clientes} clientes
              </span>
            </div>
            <div className="mt-4 h-2 rounded-full bg-white/15">
              <div className="h-2 rounded-full bg-[#f5bd19]" style={{ width: `${resumen.avance}%` }} />
            </div>
          </div>
        </div>
      </div>
